...
print("Componentes Conexas:", grafo1.componentes_conexas())
print("É Completo:", grafo1.eh_completo())
print("Possui Ciclo:", grafo1.possui_ciclo())
print("É Bipartido:", grafo1.eh_bipartido())
print("Possui Caminho Fechado:", grafo1.possui_caminho_fechado())
print("Possui Circuito Euleriano:", grafo1.possui_circuito_euleriano())
print("São Isomorfos:", grafo1.sao_isomorfos(grafo2))
